...
const uint8_t PIN_DATA = 23;  ///< SPI Data pin number
const uint8_t PIN_CLK = 18;  	///< SPI Clock pin number
const uint8_t PIN_FSYNC = 17; ///< SPI Load pin number (FSYNC in AD9833 usage)
...
void loop(void)
{
  ...
  {
    AD.setMode(modes[m]);
    AD.setFrequency(MD_AD9833::CHAN_0, 100000);
    m++;
