...
"color: rgb(0, 0, 0);")
        ...
        icon2 = QIcon()
        if QIcon.hasThemeIcon(QIcon.ThemeIcon.ZoomFitBest):
            icon2 = QIcon.fromTheme(QIcon.ThemeIcon.ZoomFitBest)
        else:
        ...
        if QIcon.hasThemeIcon(QIcon.ThemeIcon.GoUp):
            icon3 = QIcon.fromTheme(QIcon.ThemeIcon.GoUp)
        else:
        ...
        if QIcon.hasThemeIcon(QIcon.ThemeIcon.GoDown):
            icon4 = QIcon.fromTheme(QIcon.ThemeIcon.GoDown)
        else:
            icon4.addFile(u".", QSize(), QIcon.Mode.Normal, QIcon.State.Off)

        self.comboTriggerSet.addItem(icon4, "")
        icon5 = QIcon()
        if QIcon.hasThemeIcon(QIcon.ThemeIcon.MediaPlaylistShuffle):
            icon5 = QIcon.fromTheme(QIcon.ThemeIcon.MediaPlaylistShuffle)
        else:
        ...
        self.frameCH1.setFrameShape(QFrame.NoFrame)
...
"color: rgb(0, 0, 0);")
        ...
        self.frameCH2.setFrameShape(QFrame.NoFrame)
...
"color: rgb(0, 0, 0);")
        ...
        self.frameCH3.setGeometry(QRect(820, 370, 171, 121))
        self.frameCH3.setStyleSheet(u"border-color: rgb(249, 240, 107);")
        self.frameCH3.setFrameShape(QFrame.NoFrame)
...
"color: rgb(0, 0, 0);")
        ...
        self.frameCH4.setGeometry(QRect(820, 500, 171, 121))
        self.frameCH4.setStyleSheet(u"border-color: rgb(153, 193, 241);")
        self.frameCH4.setFrameShape(QFrame.NoFrame)
...
"color: rgb(0, 0, 0);")
        ...
        self.FrameControlWavegen.setGeometry(QRect(520, 0, 481, 91))
        self.FrameControlWavegen.setStyleSheet(u"background-color: rgb(255, 190, 111);\n"
"color: rgb(0, 0, 0);")
        self.FrameControlWavegen.setFrameShape(QFrame.NoFrame)
        ...
        self.frame_2 = QFrame(self.FrameControlWavegen)
        self.frame_2.setObjectName(u"frame_2")
        self.frame_2.setGeometry(QRect(500, 0, 451, 91))
        ...
        icon6 = QIcon()
        if QIcon.hasThemeIcon(QIcon.ThemeIcon.MediaSeekForward):
            icon6 = QIcon.fromTheme(QIcon.ThemeIcon.MediaSeekForward)
        else:
        ...
        self.menuBar.setGeometry(QRect(0, 0, 1003, 23))
